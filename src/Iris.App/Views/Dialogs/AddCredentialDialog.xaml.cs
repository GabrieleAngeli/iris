...
public partial class AddCredentialDialog : ContentPage
{
	private readonly ServerRowViewModel _row;
	private bool _closing;

	public AddCredentialDialog(ServerRowViewModel row)
	{
		InitializeComponent();
		BindingContext = _row = row;
		_row.AddCredentialCompleted += OnCompleted;
		Unloaded += (_, _) => Detach();
	}
	...
	private void Detach() => _row.AddCredentialCompleted -= OnCompleted;
