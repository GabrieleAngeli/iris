...
public partial class NewCustomerDialog : ContentPage
{
	private readonly CustomersViewModel _vm;
	private bool _closing;

	public NewCustomerDialog(CustomersViewModel vm)
	{
		InitializeComponent();
		BindingContext = _vm = vm;
		_vm.NewCustomerCompleted += OnCompleted;
		Unloaded += (_, _) => Detach();
	}
	...
	private void Detach() => _vm.NewCustomerCompleted -= OnCompleted;
