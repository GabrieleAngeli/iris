...
{
    /// <inheritdoc />
    public partial class InitialAccessModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerContexts_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    ScopeContextId = table.Column<Guid>(type: "uuid", nullable: true),
                    ScopeCustomerId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerContexts_CustomerId_Name",
