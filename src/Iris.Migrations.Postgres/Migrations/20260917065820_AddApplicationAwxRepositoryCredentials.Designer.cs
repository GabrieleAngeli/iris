...
namespace Iris.Migrations.Postgres.Migrations
{
    ...
    [Migration("20260917065820_AddApplicationAwxRepositoryCredentials")]
    partial class AddApplicationAwxRepositoryCredentials
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Iris.Domain.Applications.ApplicationDefinition", b =>
                {
                    ...
                    b.Property<string>("AwxRepositoryBranch")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
            ...
            modelBuilder.Entity("Iris.Domain.Applications.InstallationRun", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SubmittedVariablesJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Iris.Domain.Settings.IntegrationSettings", b =>
                {
                    ...
                    b.Property<string>("NexusEndpoint")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<string>("NexusTokenSecretReference")
                        .HasMaxLength(400)
                        .HasColumnType("character varying(400)");
