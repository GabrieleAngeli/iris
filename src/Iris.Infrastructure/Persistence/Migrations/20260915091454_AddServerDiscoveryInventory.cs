        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceName = table.Column<string>(type: "TEXT", maxLength: 260, nullable: false),
                    MountPoint = table.Column<string>(type: "TEXT", maxLength: 260, nullable: true),
                    FileSystem = table.Column<string>(type: "TEXT", maxLength: 60, nullable: true),
